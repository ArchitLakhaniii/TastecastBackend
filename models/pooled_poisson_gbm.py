...
@dataclass
class PooledPoissonGBM:
    """Global pooled count forecaster using scikit-learn HGBR with poisson loss."""
    ...
    def fit(self, feats: pd.DataFrame, y: pd.Series, feature_columns: Sequence[str]) -> "PooledPoissonGBM":
        X = feats.copy()
        X = self._encode_ids(X)
